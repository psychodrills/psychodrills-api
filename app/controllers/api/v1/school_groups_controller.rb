class Api::V1::SchoolGroupsController < ApplicationController
	...
	def create
		school_group = SchoolGroup.new(params[:school_group].except(:group_domain_name, :first_name, :middle_name, :last_name, :email, :phone_number).permit(:group_name, :address, :city, :postal_code, :country))
